...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for competitive matches and improve teamwork on the field",
    ...
    "Swimming Club": {
        ...
        "max_participants": 18,
        "participants": ["cara@mergington.edu", "jason@mergington.edu"]
    },
    "Art Workshop": {
    ...
    "Drama Club": {
        "description": "Rehearse performances and develop acting skills for school productions",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["ava@mergington.edu", "liam@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Solve challenging math problems and compete in academic tournaments",
